...
//     } else if (name === "phone") {
//       // Only allow digits and '+' at the very start
...
//         error = t("contactSection.validation.nameMin");
//       else if (value.trim().length > 50)
//         error = t("contactSection.validation.nameMax");
...
//         error = t("contactSection.validation.emailInvalid");
//     }
...
//       if (!raw) {
//         error = t("contactSection.validation.phoneRequired");
//       } else {
//         try {
//           let phoneNumber;
...
//               error = t("contactSection.validation.phoneNoLeadingZero");
//             } else if (digitsOnly.length < 6 || digitsOnly.length > 15) {
//               error = t("contactSection.validation.phoneLength");
//             }
//           }
//         } catch {
//           error = t("contactSection.validation.phoneInvalid");
...
//     if (name === "message") {
//       if (!value.trim())
//         error = t("contactSection.validation.messageRequired");
//       else if (value.length < 10)
//         error = t("contactSection.validation.messageMin");
//       else if (value.length > 500)
//         error = t("contactSection.validation.messageMax");
//     }
...
//           phoneNumber = parsePhoneNumberFromString(formData.phone);
//         } else {
//           phoneNumber = parsePhoneNumberFromString(formData.phone, "IN");
//         }
//         if (phoneNumber && phoneNumber.isValid()) {
//           normalizedPhone = phoneNumber.number; // Always E.164 "+xxxx"
//         }
//       } catch {}
...
//           phone: "",
//           message: "",
//           website: "" // include website to avoid controlled/uncontrolled warning
//         });
//         setErrors({});
//       } else {
//         Swal.fire(
//           "❌ " + t("contactSection.alerts.errorTitle"),
//           data.message || t("contactSection.alerts.errorDefault"),
//           "error"
//         );
//       }
//     } catch (error) {
...
//       Swal.fire(
//         "❌ " + t("contactSection.alerts.errorTitle"),
//         t("contactSection.alerts.serverError"),
//         "error"
//       );
//     } finally {
//       setLoading(false);
...
//         <p className="text-lg uppercase font-semibold text-[#d0440a] tracking-wider">
...
//               onChange={handleChange}
//               maxLength={50}
//               className="w-full px-4 py-3 bg-gray-50 border-0 border-b-2 border-gray-300 focus:outline-none focus:border-[#df5f04] transition-colors"
//             />
...
//             >
//               {loading
//                 ? t("contactSection.button.sending")
//                 : t("contactSection.button.send")}
//             </button>
//           </div>
//         </form>
//       </div>
        ...
        <form onSubmit={handleSubmit} className="grid grid-cols-1 md:grid-cols-2 gap-6 sm:gap-8">
          ...
          <div>
            <input
              ...
              onChange={handleChange}
              maxLength={50}
              className="w-full px-4 py-3 sm:py-4 bg-gray-50 border-0 border-b-2 border-gray-300 focus:outline-none focus:border-[#df5f04] text-sm sm:text-base transition-colors"
            />
          ...
          <div>
            <input
              ...
              className="w-full px-4 py-3 sm:py-4 bg-gray-50 border-0 border-b-2 border-gray-300 focus:outline-none focus:border-[#df5f04] text-sm sm:text-base transition-colors"
            />
            {errors.company && <p className="text-red-500 text-xs sm:text-sm">{errors.company}</p>}
          </div>
