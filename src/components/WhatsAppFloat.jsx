  ...
  return (
    <div className="fixed bottom-12 right-10 z-50">
      <button
        ...
        className="w-12 h-12 rounded-full bg-green-500 hover:bg-green-600 transition-all duration-300 shadow-lg flex items-center justify-center group"
        aria-label="Contact us on WhatsApp"
      >
        <svg
          className={`w-8 h-8 text-white transition-transform duration-300 ${isHovered ? 'scale-110' : ''}`}
          fill="currentColor"
          viewBox="0 0 24 24"
